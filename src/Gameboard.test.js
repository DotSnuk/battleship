...
describe('Gameboard', () => {
  ...
  it('Place ship with id', () => {
    expect(board.placeShip(1, 'horizontal', 'b', 2)).toBeTruthy();
  });
  ...
  it('Try second ship again, shouldnt collide', () => {
    expect(board.placeShip(2, 'vertical', 'B', 3)).toBeTruthy();
  });

  it('Try third ship, should collide', () => {
    expect(board.placeShip(3, 'horizontal', 'A', 3)).toBeFalsy();
  });
